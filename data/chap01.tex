...
\label{cha:intro}
\section{交通工程与交通控制概述}
交通工程起源于土木工程领域的道路工程分支。第二次世界大战以后，为了尽快恢复受到破坏的工业，各工业发达国家都大规模修建公路，
推动相关行业发展。随着经济的复苏，小汽车拥有量大幅增加，在带给人们舒适与便捷的同时引起了一系列前所未有的交通问题\cite{xujiqian2002jiaotonggongcheng}。
人们意识到道路并不应当仅仅满足力学和造价的要求。例如：道路线形与交通安全息息相关；合理的路网结构可以产生最优的交通分配；优
化的信号配时可以充分利用交叉口的时空资源；便捷的公共交通可以鼓励更多的人放弃小汽车，从而降低交通压力，减少油耗和排放。这些
新兴的研究领域促使交通工程突破了力学设计的范畴。经过半个世纪的发展，交通工程已经成为门类齐全的学科。国内很多知名高校，如同
济大学、西南交通大学都设置了独立的交通学院，成为推动这门学科继续发展的中坚力量。
...
\begin{table}[htb]
  ...
  \label{tab:template-files}
    \begin{tabular*}{\linewidth}{lp{10cm}}
      ...
      tongjithesis.ins & \LaTeX{} 安装文件，docstrip\footnote{表格中的脚注} \\
      tongjithesis.dtx & 所有的一切都在这里面\footnote{再来一个}。\\
      tongjithesis.cls & 模板类文件。\\
      tongjithesis.cfg & 模板配置文。cls 和 cfg 由前两个文件生成。\\
...
本模板推荐使用 BIB\TeX，样式文件为 tongjibib.bst，基本符合学校的参考文献格式（如专利
